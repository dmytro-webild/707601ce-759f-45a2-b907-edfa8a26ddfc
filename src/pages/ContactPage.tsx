      ...
      items={[
        {
          ...
          answer: "If you experience an issue while using a J&E Technologies charging station, please contact us by phone or email. Please include the charging station location, a description of the issue, and any relevant details so we can assist you quickly.",
        },
        {
